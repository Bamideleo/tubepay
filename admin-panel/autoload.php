        ...
        <div class="navigation">
            ...
            <div class="navigation-menu-body">
                <ul>
                    ...
                    <li <?php echo ($page == 'create-site' || $page == 'manage-site') ? 'class="open"' : ''; ?>>
                        <a href="#">
                            <span class="nav-link-icon">
                        ...
                        <ul <?php echo ($page == 'create-site' || $page == 'manage-site') ? 'style="display: block;"' : ''; ?>>
                            <li>
                                <a <?php echo ($page == 'create-site') ? 'class="active"' : ''; ?> href="<?php echo PT_LoadAdminLinkSettings('create-site'); ?>" data-ajax="?path=create-site">Create Site</a>
                            </li>
                            <li>
                                <a <?php echo ($page == 'manage-site') ? 'class="active"' : ''; ?> href="<?php echo PT_LoadAdminLinkSettings('manage-site'); ?>" data-ajax="?path=manage-site">Manage Site</a>
                            </li>
                    ...
                    <li <?php echo ($page == 'general-settings' || $page == 'site-settings' || $page == 'email-settings' || $page == 'social-login' || $page == 's3' || $page == 'live' || $page == 'ffmpeg' || $page == 'video_settings') ? 'class="open"' : ''; ?>>
                        ...
                        <?php if($pt->user->admin == 1 && $pt->user->super_admin==1):?> 
                        <li>
